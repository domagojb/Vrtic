  ...
  <body>
	...
	<div class="row">
	  <div class="large-12 columns">
        <h1>Izmjena korisničkih podataka</h1>
	  	<c:choose>
	      <c:when  test="${option == 'Izmijeni podatke'}">
	        ...
	        <div class="row">			
			  ...
			  <div class="large-6 columns">			     
			    ...
			    <input type="radio" name="userType" value="edu" checked><label>Odgajatelj</label>
				<input type="radio" name="userType" value="acc"><label>Računovođa</label>
			  </div>
			</div>
	      ...
	      <c:when test="${option == 'Izmijeni grupu'}">
	      </c:when>
	      <c:otherwise>
	       <form method="post" action="${pageContext.request.contextPath}/userpanel/edituser/editor">
	       <input type="hidden" name="id" value="${id}" />	       	     
